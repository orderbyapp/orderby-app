...
export default class WaiterRate extends Component {
    constructor() {
      super()
      this.state = {
        rating: 2,
    ...
    handleRate({ rating }) {
      ...
      this.setState({ rating, from, to, message : 1 })
    }
      ...
      return (
        <div>
          <div className={`container fixed mt-3 animated-waiter  ${this.state.classAnimated}`}>
            ...
            <p className='pt-1'>Gracias por tu valoración, esperamos volver a verte pronto!</p>
